...
return [
    ...
    'sandbox' => [
        'client_id' => env('PAYPAL_SANDBOX_CLIENT_ID', ''), //config('paypal.client_id'), //env('PAYPAL_SANDBOX_CLIENT_ID', ''),
        'client_secret' => env('PAYPAL_SANDBOX_CLIENT_SECRET', ''), //config('paypal.client_secret'), //env('PAYPAL_SANDBOX_CLIENT_SECRET', ''),
