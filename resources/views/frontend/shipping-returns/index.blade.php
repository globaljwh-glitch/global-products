         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  ...
                  <p>We offer an online return process designed to make returns simple and convenient. If you prefer not to use the online return system, you may contact us to request a return authorization. Please have the following information available when submitting your request:</p>
                  <ul class="listing01">
                     <li>Customer Name</li>
