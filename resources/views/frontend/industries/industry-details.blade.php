                ...
                <div class="col-12">
                      ...
                      <div class="alert alert-light text-center py-5 border">
                        <p class="mb-0">
                         ...
                         <a class="customBtn01 mt-2 redBg text-white" href="{{route('industries.index')}}">Browse Other Industries</a>
                      </div>
    ...
    <div class="row">
       <div class="col-md-12">
          <div class="headingBlock underLineHeading d-flex align-items-center justify-content-between">
             ...
             <a href="{{ route('products.index', ['type' => 'industry', 'slug' => $industry->slug]) }}" class="customBtn01 blackBg">View All</a>
          </div>
       </div>
       ...
       @if(isset($industry->brands) && !empty($industry->brands))
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 d-flex align-items-center">
                <a href="{{route('brands.details',$brand->slug)}}" class="partner">
                    <div class="partnerLogo"><img src="{{ asset('storage/'.$brand->logo) }}" alt="" target="_blank" class="imgResponsive" /></div>
                </a>
            </div>
             @endforeach
             @else
