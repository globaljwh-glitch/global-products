            ...
            <div class="row">
               <div class="d-flex align-items-center col-md-6 order-1 order-md-0">
                  <div class="w-100 pe-0 pe-lg-4 pt-3 pt-lg-0">
                     ...
                     <p class="pe-0 pe-lg-3">Global Products Corporation is a trusted supplier of industrial products, equipment, and business solutions, <span class="text-red fw-bold">serving customers across diverse industries with a commitment to quality, reliability, and operational excellence</span>. Our comprehensive portfolio includes premium industrial supplies, facility maintenance products, material handling equipment, safety solutions, storage systems, and other essential business products designed to <span class="text-red fw-bold">support efficient operations.</span></p>
                     <p class="pe-0 pe-lg-3"><span class="text-red fw-bold">Built on strong customer relationships and industry expertise</span>, we help businesses streamline procurement through dependable service, competitive pricing, and consistent product availability. By combining innovative sourcing strategies with a customer-first approach, <span class="text-red fw-bold">Global Products Corporation continues to deliver solutions that improve productivity</span> and support long-term business success.</p>
                  </div>
               </div>
