    ...
    <div class="row">
       <div class="col-md-12">
          <div class="headingBlock pb-3 text-center">
             <h2 class="fw-bold">Reliable Industrial <span>Solutions to Keep {{$brand->name}}</span> Moving</h2>
          </div>
       </div>
       <div class="productCategoriesList text-center">
          <div class="row d-flex justify-content-center">
            @if(isset($brand->categories) && !empty($brand->categories))
             ...
             <div class="col-sm-3 col-lg-2 d-flex">
                <a href="{{ url('category/'.$category->slug) }}" class="categoriesBox text-center">
                   <div class="categoriesThumb">
                    <img src="{{ asset('storage/'.$category->image) }}" class="imgResponsive"></div>
                   <h6 class="categoriesName mb-0">{{$category->name}}</h6></a>
                </a>
             </div>
             @endforeach
             @else
                <div class="col-12">
                      ...
                      <div class="alert alert-light text-center py-5 border">
                        <p class="mb-0">
                              Sorry, We couldn't find any Category in this Brand.
                        </p>
                         <a class="customBtn01 mt-2 redBg text-white" href="{{route('brands.all')}}">Browse Other Brand</a>
                      </div>
    ...
    <div class="row">
       <div class="col-md-12">
          <div class="headingBlock underLineHeading d-flex align-items-center justify-content-between">
             <h2>Top Selling In {{$brand->name}} Brand</h2>
             <a href="{{ route('products.index', ['type' => 'brand', 'slug' => $brand->slug]) }}" class="customBtn01 blackBg">View All</a>
          </div>
       </div>
                  ...
                  <div class="col-12">
                      ...
                      <div class="alert alert-light text-center py-5 border">
                         <img src="{{ asset('images/no-product.png') }}" width="300">
                          ...
                          <p class="mb-0">
                              Sorry, We couldn't find any products in this Brand.
                          </p>
                          <a class="customBtn01 mt-2 redBg text-white" href="{{route('brands.all')}}">Browse Other Brand</a>
                      </div>
