<div class="topBar blueBg d-flex">
         <div class="container">
            <div class="row">
               <div class="col-md-6 d-flex align-items-center">
                  <p class="mb-0 fw-medium">Summer sale discount 50% off! <a href="{{ route('products.index') }}">Shop Now</a></p>
               </div>
      ...
      <header>
         <nav class="navbar navbar-expand-lg">
            <div class="container">
               <a class="navbar-brand" href="{{ route('home.index') }}"><img src="{{ asset('images/logo.jpg') }}" alt="Global Products Corporation" class="imgResponsive" /></a>
               ...
               <div class="collapse navbar-collapse order-2 order-md-2 order-lg-0" id="navbarNavDropdown">
                  <ul class="navbar-nav m-auto">
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Shop By Brands</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                           <li>
                              <a class="dropdown-item" href="{{ route('products.index') }}">Storage &amp; Shelving</a>
                              <a class="dropdown-item" href="{{ route('products.index') }}">Safety &amp; Security</a>
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Shop By Industry</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                           <li>
                              <a class="dropdown-item" href="{{ route('products.index') }}">Storage &amp; Shelving</a>
                              <a class="dropdown-item" href="{{ route('products.index') }}">Safety &amp; Security</a>
